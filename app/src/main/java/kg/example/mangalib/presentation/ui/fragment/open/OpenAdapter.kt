...
class OpenAdapter:RecyclerView.Adapter<OpenAdapter.OpenViewModel> (){
    ...
    inner class OpenViewModel(private val binding: ItemOpenBinding) :RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OpenViewModel {
        return OpenViewModel(ItemOpenBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
